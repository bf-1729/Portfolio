...
const Skill = () => {
  ...
  return (
    <div id='skill' className='bg-gray-800 mx-auto lg:-mt-12 mt-[0rem] lg:w-3/4 w-full'>
      ...
      <div className='grid lg:grid-cols-4 grid-cols-3 lg:mt-10 mt-4 gap-y-2.5'>
        ...
        {skillArray.map((item) => (
          <div className='transition delay-100 duration-100 ease-in hover:-translate-y-2 px-1'>
