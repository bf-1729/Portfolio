...
const About = () => {
  return (
    <div id='about' className='container mx-auto lg:-mb-8 mb-16 lg:w-4/5 w-full h-screen'>

      <div className='flex items-center lg:flex-row flex-col-reverse lg:border-none border-2 border-gray-500 lg:h-5/6 w-[100%] h-fit mt-4 rounded-lg lg:p-0 pb-4 gap-4'>
